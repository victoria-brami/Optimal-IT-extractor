...
def display_label_selection_instructions():
    ...
    INSTRUCTIONS_OPTIMAL_TI_SELECTION += '  1) For a given sequence, write on the side the images index candidates for optimal TI.\n '
    INSTRUCTIONS_OPTIMAL_TI_SELECTION += '  Ex: if the images 4, 5, and 6 are optimal, write down "4 5 6" \n \n'
    INSTRUCTIONS_OPTIMAL_TI_SELECTION += '  2) If the CSV file is open, please close it before !! \n \n'
    INSTRUCTIONS_OPTIMAL_TI_SELECTION += '  3) Press ESCAPE button when you finished labelling the sequence  \n \n'
    INSTRUCTIONS_OPTIMAL_TI_SELECTION += '  4) If you want to STOP labelling, press ESCAPE button without filling the box \n'
    app = QApplication([])
    message = QMessageBox()
...
def display_annotations_error():
    """
    Explains to the user the shape of the labels and where they have been stored in his computer.
    :return: None
    """
    # Message displayed in the window
    ANNOTED_LABEL_INFORMATION = ' BEWARE YOU MADE A MISTAKE WHILE FILLING DATA INFORMATION \n \n'
